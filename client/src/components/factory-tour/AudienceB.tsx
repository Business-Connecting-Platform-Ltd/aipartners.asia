...
const ABOUT_DATA = [
    {
        ...
        bullets: [
            "Thiết kế và điều phối chương trình Factory AI Enhance Transformation.",
    ...
    },
    {
        ...
        bullets: [
            ...
            "Mang góc nhìn vận hành thực tế vào từng buổi Factory AI Enhance Transformation.",
...
const PROCESS_DATA = [
    {
        num: "01",
        title: "Khảo sát online / offline 30 phút ",
        tag: "Miễn phí",
        desc: "Gửi survey & phỏng vấn ban lãnh đạo để hiểu hiện trạng, paint points, dữ liệu sẵn có.",
    },
    {
        num: "02",
    ...
    {
        num: "03",
        title: "Factory AI Enhance Transformation Tour",
        tag: "Tại nhà máy",
    ...
    },
    {
        ...
        desc: "Tổng hợp đề xuất từ các đối tác + góc nhìn trung lập từ BCP & AIPartners.",
    },
];
...
const BENEFITS = [
    ...
    },
    {
        ...
        points: [
            "BCP & AIPartners đứng giữa, giúp đánh giá tính phù hợp & khả thi tổng thể.",
...
const FAQ_DATA = [
    {
        ...
        a: "Chương trình Factory AI Enhance Transformation giai đoạn đầu là hoàn toàn miễn phí cho nhà máy. Chỉ khi nhà máy quyết định triển khai giải pháp cụ thể mới phát sinh chi phí.",
    },
    {
                            ...
                            >
                                ...
                                <div className="inline-flex items-center gap-3 mb-4 lg:mb-6">
                                    ...
                                    <span className="text-[10px] lg:text-xs tracking-[0.25em] uppercase" style={{ color: COLORS.gold }}>
                                        Factory AI Enhance Transformation
                                    </span>
                                </div>
                                ...
                                <p className="text-base lg:text-lg text-white/60 max-w-xl mb-6 lg:mb-8 leading-relaxed">
                                    Chương trình <span className="text-white/90 font-medium">Factory AI Enhance Transformation Tour</span> giúp Ban lãnh đạo
                            ...
                            >
                                <GlassCard glow className="p-8 lg:p-10 rounded-3xl">
                                    ...
                                    <p className="text-white/60 mb-6 leading-relaxed">
                                        Factory AI Enhance Transformation được thiết kế để giải quyết chính những nỗi lo này.
                                    </p>
                                    ...
                                    <div className="p-5 rounded-2xl border border-white/10 mb-6" style={{ backgroundColor: `${COLORS.gold}10` }}>
                                        ...
                                        <div className="space-y-2">
                                            {["Khảo sát online / offline 30 phút nắm rõ nhu cầu", "Danh sách 6–8 đội giải pháp phù hợp", "Lộ trình quick win → mở rộng quy mô"].map((item) => (
                                    ...
                                    {!isSuccess ? (
                                        <form onSubmit={handleSubmit} className="space-y-5">
                                            ...
                                            <Button
                                                ...
                                                style={{ backgroundColor: COLORS.navy }}
                                            >
                                                {isSubmitting ? "Đang gửi..." : "Đăng ký Khảo sát MIỄN PHÍ"}
                                                <ArrowRight className="ml-2 h-5 w-5" />
                                            </Button>
                                        </form>
                                    ) : (
